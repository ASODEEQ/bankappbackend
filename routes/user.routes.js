...
const {signupPage,checkk,loginPage, forgotPass, DashboardData, authenticateToken, resolveAccount, transferFunds, depositFunds, getTransactionHistory}= require('../controller/user.controller')
